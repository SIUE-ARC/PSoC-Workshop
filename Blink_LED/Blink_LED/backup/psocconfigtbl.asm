...
;       Instance name PWM8, Block Name PWM8(DBB00)
	...
	db		21h, b6h		;PWM8_PERIOD_REG(DBB00DR1)
	db		22h, 5bh		;PWM8_COMPARE_REG(DBB00DR2)
...
;  Instance name PWM8, User Module PWM8
;       Instance name PWM8, Block Name PWM8(DBB00)
	db		20h, 29h		;PWM8_FUNC_REG(DBB00FN)
	db		21h, 11h		;PWM8_INPUT_REG(DBB00IN)
	db		22h, 47h		;PWM8_OUTPUT_REG(DBB00OU)
...
;  Ordered Global Register values
	...
	mov	reg[01h], f3h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], d3h		; Port_0_DriveMode_2 register (PRT0DM2)
